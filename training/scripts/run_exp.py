...
# [PATH FIX] Add project root to sys.path to allow imports from src
# Script location: training/scripts/run_exp.py
...
def main():
    ...
    # Resolve 'data_path' relative to Project Root (training/)
    ...
    # Point 'weights_dir' to our pretrained_weights folder relative to Project Root
